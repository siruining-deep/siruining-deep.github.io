...
Static HTML/CSS website for GitHub Pages, with Home, About, and Papers pages.
...
2. Upload index.html, about.html, papers.html, styles.css, README.md, .nojekyll, and the eleven note PDFs to the root of `main`. `index.html` must be at the repository root.
